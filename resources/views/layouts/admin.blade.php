...
<head>
    ...
    <title>Sistema de Ecommerce - Admin</title>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <div class="logo mb-2">
                            <a href="{{ url('/admin') }}" class="d-flex justify-content-center">
                                <img src="{{ url('/storage/' . $ajuste->logo) }}" alt="logo"
                                    style="height: 50px; width: auto; border-radius: 8px; margin-bottom: .8rem;">
                            </a>
                        </div>

                        <!-- Nombre debajo del logo -->
                        <div class="brand-name mb-3">
                            <h5 class="mb-0">{{ $ajuste->nombre ?? env('APP_NAME') }}</h5>
                        </div>

                        <!-- Controles centrados -->
                        <div class="d-flex justify-content-center align-items-center gap-2">
                            <!-- Toggle de tema con SVGs originales -->
                            <div class="theme-toggle d-flex gap-2 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 21 21" fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path
                                        d="M10.5 14.5c2.219 0 4-1.763 4-3.982a4.003 4.003 0 0 0-4-4.018c-2.219 0-4 1.781-4 4c0 2.219 1.781 4 4 4z" />
                                    <path d="M4.136 4.136L5.55 5.55" />
                                    <path d="M9.9 9.9l1.414 1.414" />
                                    <path d="M1.5 10.5h2" />
                                    <path d="M14 10.5h2" />
                                    <path d="M4.135 16.863L5.55 15.45" />
                                    <path d="M9.899 9.9l1.414-1.415" />
                                    <path d="M10.5 19.5v-2" />
                                    <path d="M10.5 5.5v-2" />
                                </svg>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.cuenta.*') ? 'active' : '' }} has-sub">
                            ...
                            <ul class="submenu {{ request()->routeIs('admin.cuenta.*') ? 'active' : '' }}">
                                <li
                                    class="submenu-item {{ request()->routeIs('admin.cuenta.perfil') ? 'active' : '' }}">
                                    <a href="{{ route('admin.cuenta.perfil', Auth::id()) }}" class="submenu-link">Mi
                                        Perfil</a>
                                </li>
