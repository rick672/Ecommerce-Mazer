            ...
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8">
                    <div class="card shadow-lg border-0 text-center p-5 bg-light-subtle">
                        ...
                        <p class="lead mb-4">
                            Tu pedido ha sido procesado con éxito y esta confirmado. Recibirás una copia de esta
                        ...
                        <div class="confirmation-details d-flex justify-content-around fw-bold flex-wrap">
                            ...
                            <span class="mb-2 mb-md-0">
                                **Fecha:** <span
                                    class="text-secondary">{{ \Carbon\Carbon::parse($orden->created_at)->format('d-m-Y H:i:s') }}</span>
                            </span>
                            {{-- <span class="mb-2 mb-md-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-7" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="order-items list-group mb-4">
                        @foreach ($orden->detalles as $detalle)
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-2">{{ $detalle->producto->nombre }}</h6>
                                    @php
                                        $imagen_producto = $detalle->producto->imagenes->first();
                                        $imagen = $imagen_producto->imagen ?? '';
                                    @endphp
                                    <img src="{{ asset('storage/' . $imagen) }}" width="100px" alt="Product Image" class="img-fluid mb-2"
                                        loading="lazy"><br>
                    ...
                    <div class="card p-3 mb-4 border-info-subtle bg-info-subtle">
                        ...
                        <p class="card-text mb-0">
                            {{ $orden->direccion_envio ?? 'No se ha especificado ninguna dirección.' }}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="card shadow-sm p-4 mb-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="d-flex justify-content-between fw-bold pt-2 border-top">
                                <span>Total:</span>
                                <span
                                    class="text-success fs-5">{{ $orden->divisa . ' ' . number_format($orden->total, 2, '.', '') }}</span>
                            </li>
                        </ul>
                    ...
                    <div class="card shadow-sm p-4 mb-4">
                        ...
                        <p class="mb-2"><i class="bi bi-envelope me-2 text-success"></i> Revisa tu correo electronico para
                            la factura detallada.</p>
                        <p class="mb-2"><i class="bi bi-truck me-2 text-success"></i> Recibiras una notificación por
                            correo electrónico cuando el pedido sea enviado.</p>
                        <p class="mb-0"><i class="bi bi-check-circle me-2 text-success"></i> ¡Listo! Tu pedido ha sido
                            procesado con éxito.</p>
                    </div>
                </div>
            </div>
        </div>
