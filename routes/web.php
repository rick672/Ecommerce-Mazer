...
Route::get('/admin', [App\Http\Controllers\AdminController::class, 'index'])->name('admin')->middleware('auth', 'can:Dashboard del Administrador');
...
Route::get('/admin/rol/{id}', [App\Http\Controllers\RoleController::class, 'show'])->name('admin.roles.show')->middleware('auth', 'can:Detalles de Rol');
...
Route::get('/admin/rol/{id}/permisos', [App\Http\Controllers\RoleController::class, 'permisos'])->name('admin.roles.permisos')->middleware('auth', 'can:Detalles de Permisos de Rol');
...
Route::get('/admin/usuario/{id}/perfil', [App\Http\Controllers\UsuarioController::class, 'perfil'])->name('admin.cuenta.perfil')->middleware('auth', 'can:Ver Perfil de Usuario');
Route::put('/admin/usuario/{id}/update_perfil', [App\Http\Controllers\UsuarioController::class, 'update_perfil'])->name('admin.cuenta.update_perfil')->middleware('auth', 'can:Actualizar Perfil de Usuario');
Route::put('/admin/usuario/{id}/update_password', [App\Http\Controllers\UsuarioController::class, 'update_password'])->name('admin.cuenta.update_password')->middleware('auth', 'can:Actualizar Contraseña de Usuario');
...
Route::get('/admin/categoria/{id}', [App\Http\Controllers\CategoriaController::class, 'show'])->name('admin.categorias.show')->middleware('auth', 'can:Detalles de Categoria');
Route::get('/admin/categoria/{id}/edit', [App\Http\Controllers\CategoriaController::class, 'edit'])->name('admin.categorias.edit')->middleware('auth', 'can:Editar Categoria');
...
Route::get('/admin/producto/{id}', [App\Http\Controllers\ProductoController::class, 'show'])->name('admin.productos.show')->middleware('auth', 'can:Detalles de Producto');
Route::get('/admin/producto/{id}/imagenes', [App\Http\Controllers\ProductoController::class, 'imagenes'])->name('admin.productos.imagenes')->middleware('auth', 'can:Gestionar Imagenes de Producto');
Route::post('/admin/producto/{id}/upload_imagen', [App\Http\Controllers\ProductoController::class, 'upload_imagen'])->name('admin.productos.upload_imagen')->middleware('auth', 'can:Subir Imagenes de Producto');
Route::delete('/admin/producto/imagen/{id}/destroy_imagen', [App\Http\Controllers\ProductoController::class, 'destroy_imagen'])->name('admin.productos.destroy_imagen')->middleware('auth', 'can:Eliminar Imagenes de Producto');
...
Route::get('/paypal/orden_completada/{id}', [App\Http\Controllers\PaypalController::class, 'orden_completada'])->name('web.paypal.orden_completada');
